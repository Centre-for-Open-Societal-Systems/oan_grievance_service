...
| ------------------------------- | -------------------------- | :------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Phase 0: Party Resolution**   | `submitters`               |      **SELECT / INSERT / UPDATE**      | • `id` (UUIDv7 PK)<br/>• `dedupe_key` (`fayda:123...` or `phone:+251...`)<br/>• `submitter_type_id` (FK → `submitter_types.id`)<br/>• `full_name`, `phone`, `email`, `farmer_id`<br/>• `administrative_area`, `administrative_unit`<br/>• `identity_verified_at` (timestamptz)<br/>• `is_blocked` (checked; aborts if `1`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
